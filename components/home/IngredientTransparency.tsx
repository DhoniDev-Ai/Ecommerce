...
const ingredients = [
    { name: "Sea Buckthorn", emoji: "🍊", origin: "Himalayan Valleys", speed: 0.1, alt: "Rich in antioxidants, supports energy and skin health" },
    { name: "Amla", emoji: "🫒", origin: "Indian Orchards", speed: 0.2, alt: "Supports immunity and natural vitamin C intake" },
    { name: "Turmeric", emoji: "💛", origin: "Kerala Farms", speed: 0.15, alt: "Helps reduce inflammation and supports joint health" },
    { name: "Ginger", emoji: "🫚", origin: "Organic Growers", speed: 0.25, alt: "Aids digestion and improves metabolism" },
];
                    ...
                    <div data-scroll data-scroll-speed="1">
                        ...
                        >
                            ...
                            <h2 className="font-heading text-4xl lg:text-5xl text-[#2D3A3A] leading-[1.1] tracking-tighter mb-8">
                                We believe in <br />
                                <span className="italic font-serif font-light text-[#5A7A6A]">complete Ayurvedic transparency</span>
                            </h2>
                            <p className="text-lg text-[#6A7A7A] leading-relaxed mb-10 font-light max-w-md">
                                Every ingredient we use is carefully sourced from trusted farms.
                                <span className="font-medium"> No hidden Additives, No Artificial Preservatives. Just pure Nature, Preserved at its Peak.</span>
                            </p>

                            {/* Philosophy Checklist */}
                            <div className="space-y-5">
                                {[
                                    "100% transparent ingredient labeling",
                                    "Farm‑sourced Ayurvedic ingredients",
                                    "Third‑party tested for purity & safety",
                                    "No artificial colors, preservatives, or chemicals",
                                ].map((item, index) => (
                                    <motion.div
                                        key={index}
                        ...
                        <div className="smalltext font-medium opacity-70 text-xs mt-8">
                            Backed by Ayuniv • Clean Label • Made in India
                        </div>
                    </div>

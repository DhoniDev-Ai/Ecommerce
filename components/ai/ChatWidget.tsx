...
export function ChatWidget() {
    ...
    return (
        <>
            {/* 1. Floating Trigger Button (Only visible when closed) */}
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                    ...
                    >
                        {/* <div className="absolute rounded-full inset-0 bg-linear-to-tr from-[#5A7A6A] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" /> */}
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-6 right-6 z-50 w-[90vw] md:w-[400px] h-[600px] max-h-[80vh] bg-white/80 backdrop-blur-2xl border border-white/20 rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden"
                    >
                        {/* Header */}
                        <div className="p-6 bg-[#2D3A3A] text-white flex justify-between items-center relative overflow-hidden">
                        ...
                        {/* Input Area */}
                        <div className="p-4 bg-white border-t border-[#E8E6E2]">

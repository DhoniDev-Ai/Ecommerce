-- =====================================================
-- AYUNIV PRODUCT DATA - WITH SUPABASE STORAGE URLS
-- Run this AFTER 001_schema_updates.sql
-- =====================================================
-- Base URL: https://rcrbbvnrkwjtyjyytarx.supabase.co/storage/v1/object/public/product-images/
-- =====================================================
...
INSERT INTO products (
    ...
    ARRAY['https://rcrbbvnrkwjtyjyytarx.supabase.co/storage/v1/object/public/product-images/sea_buckthorn_pulp_300ml.png'],
    ARRAY['Energy', 'Immunity', 'Skin Health'],
    50,
    '{"calories": 70, "sugar": "12g", "fiber": "2g", "serving_size": "10 fl oz"}'::jsonb,
    '[{"name": "Organic Sea Buckthorn Berries", "certification": "CERTIFIED ORGANIC"}]'::jsonb,
...
INSERT INTO products (
    ...
    ARRAY['https://rcrbbvnrkwjtyjyytarx.supabase.co/storage/v1/object/public/product-images/sea_buckthorn_pulp_500ml.png'],
...
INSERT INTO products (
    ...
    ARRAY['https://rcrbbvnrkwjtyjyytarx.supabase.co/storage/v1/object/public/product-images/duo_shecare.png'],
...
INSERT INTO products (
    ...
    ARRAY['https://rcrbbvnrkwjtyjyytarx.supabase.co/storage/v1/object/public/product-images/demo1.jpg'],
...
INSERT INTO products (
    ...
    ARRAY['https://rcrbbvnrkwjtyjyytarx.supabase.co/storage/v1/object/public/product-images/heromi.png'],
...
INSERT INTO products (
    ...
    ARRAY['https://rcrbbvnrkwjtyjyytarx.supabase.co/storage/v1/object/public/product-images/cholesterol-care.png'],
...
INSERT INTO products (
    ...
    ARRAY['https://rcrbbvnrkwjtyjyytarx.supabase.co/storage/v1/object/public/product-images/demo2.jpg'],
...
-- Verify
SELECT 'Product data seeded successfully! Total products: ' || COUNT(*)::text FROM products;
SELECT name, slug, price, image_urls[1] as first_image FROM products ORDER BY created_at;
